...
if (window.location.origin.includes("localhost")) {
    ...
    */
    ...
    try {
        ...
        // Derive appPath from the <base href> (e.g. "/app/") rather than
        // assuming root. The WASM dev server serves the app under that path now
        // (ASPNETCORE_PATHBASE), so the localhost WASM mounts at /app/ just like the
        // cloud — LzHost.AppPath must match or in-app routing / asset paths diverge.
